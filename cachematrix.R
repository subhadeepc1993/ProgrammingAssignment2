...
## functions do
## These functions have been written for the fulfillment of Coursera Data Science: R Programming 
...
inv <- NULL                                 ## initializes inv as NULL; will hold value of matrix inverse 
    ...
    get <- function() x                     ## defines the get fucntion - returns value of the matrix argument
